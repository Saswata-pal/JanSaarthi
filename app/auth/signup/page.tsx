...
import { ArrowLeft, Brain, Target, Shield, Users } from 'lucide-react'
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                >
                    ...
                    {isLoading && (
                        <div style={{
                            ...
                            <span style={{ fontSize: '0.875rem', color: '#6B7280' }}>Creating your account...</span>
                        </div>
                    )}
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', fontSize: '0.875rem', color: '#374151' }}>
                                <Target style={{ width: '16px', height: '16px', color: '#8B5CF6', marginRight: '0.5rem', flexShrink: 0 }} />
                                <span>Personalized assistance roadmaps</span>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', fontSize: '0.875rem', color: '#374151' }}>
                ...
                >
                    <p>Secure & Private • Free to start • Trusted by citizens</p>
                </motion.div>
            </div>
